...
from itertools import *
				#X	284187	291629	ENSG00000182378	.	+	284187	291629	.	4	127,137,129,131	0,4545,6460,7311
...
#1	939274	939460	ENSG00000187634	2	+
bed_dict_int = defaultdict(list)
bed_dict_chrom = {}
bed_dict_strand = {}
with open("/home/mitch/Desktop/ribo/depth/Homo_sapiens.GRCh38.95_CDS_filter_exp_collapse_WSN.bed") as r:
	for line in r:
		new_line = line.split("\t")
...
#comp_list = [(0,3),(1,4),(2,5)]
comp_list = [(0,1),(0,2),(1,2)]

write_file = open("/home/mitch/Desktop/ribo/depth/pause_wt_8.bed","a")


with open("/home/mitch/Desktop/ribo/depth/concat_CDScoverageGRCH38flu.depth") as r:
	for line in r:
